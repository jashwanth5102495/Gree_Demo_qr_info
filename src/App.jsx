...
export default function App() {
  return (
    <div className="relative flex items-center justify-center min-h-screen px-3 sm:px-4 pt-12 sm:pt-14 pb-6 sm:pb-8">
      ...
      <div className="fixed inset-0 -z-20 bg-black/40 pointer-events-none"></div>
      ...
      <ProductCard
        ...
        composition={[
          '(i) Total water soluble humates and fulvates: percent weight by volume, minimum 22',
          '(ii) pH (1:5 aqueous solution): 9.0 (min)',
          '(iii) Specific gravity: 1.05',
        ]}
        crops="Ground Nut"
        dosage="Two soil applications at 1.25L/ha"
      />
    </div>
  );
}
